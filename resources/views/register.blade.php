    ...
    <div class="flex flex-col gap-10 p-3 w-full xs:w-96">
        ...
        <div class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2">
                <h1 class="text-2xl xs:text-3xl font-semibold tracking-tight">Sign up a new account</h1>
                <p class="">
                    <span>Already a member?</span>
                    <a href="{{route('login_page')}}" class="font-medium hover:underline">Login here</a>
                </p>
            </div>
        </div>

        <form action="{{route('register_user')}}" class="flex flex-col gap-4" method="post">
            @csrf
            <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-2">
                <label for="password" class="font-medium cursor-pointer self-start">Password</label>
